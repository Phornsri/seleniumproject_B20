...
public class P2_MerriamWebster_Links {
    public static void main(String[] args){
        ...
        System.out.println("The number of links that does noe have text = " +linksWithoutText );

        //5. Print out how many link has text
        System.out.println("The number of links that does noe Has text = " + linksWithText );
